...
def train_ppo(ppo, writer):
    ...
    for i_episode in range(1, max_episodes + 1):
        ...
        if i_episode % 100 == 0:
            torch.save(ppo.policy.state_dict(), './runs/PPO/PPO_continuous_{}.pth'.format(env_name))
...
if __name__ == '__main__':
    ...
    writer = SummaryWriter(log_dir="./runs/PPO/{}_PPO".format(datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")))
    train_ppo(ppo, writer)
